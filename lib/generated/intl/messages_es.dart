...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m2(howMany) => "${Intl.plural(howMany, one: 'Tienes 1 mensaje', other: 'Tienes ${howMany} mensajes')}";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static _notInlinedMessages(_) => <String, Function> {
    "pageHomeListTitle" : MessageLookupByLibrary.simpleMessage("Algunas cadenas localizadas"),
